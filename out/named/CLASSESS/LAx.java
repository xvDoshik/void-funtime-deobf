...
implements ModInitializer {
     ...
     */
    private void ZBHb(DrawContext class_3322, RenderTickCounter class_97792) {
     ...
     */
    private void Eq() {
        File file = new File((File)((Object)LAx.SaYCkl("LBaQd", 1, 0, 1691, 23, 10, 14, -1582615234, 412485447, -762420368, (MinecraftClient)LAx.SaYCkl("Shrjyx", 6, 0, 1630, 23, 11, 27, -1279718408, -2092601536, -862948381))), (String)( /* dynamic constant */ (Object)feG.fL("ci", MethodHandles.lookup(), "fL", LAx.class, "\u00d0\u00bb\u0082\u0013", -1233980519, -1415334961, 1965397797, 1)));
    ...
    private static void AJ(MinecraftClient class_3102) {
        try {
